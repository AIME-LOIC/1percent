...
-- 4. DEPRECATED filler no longer seeded here.
--    Challenge-specific hints are generated by fix_challenge_hints.js
--    (backend/services/hintGenerator.js) and applied via
--    migrations/fix_challenge_hints.sql. That script also REPLACES these
--    generic fillers wherever they are still present:
...
-- ⚠️ After running this migration, run fix_challenge_hints.js to replace
--    the above fillers with challenge-specific hints.
