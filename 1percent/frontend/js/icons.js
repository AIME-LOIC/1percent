/* ============================================================
   SVG Icons — Inline Lucide-style icons
   ============================================================
   All icons are 24x24, stroke-based, currentColor for easy
   theming. Use: Icons.get('icon-name') returns SVG string.
   ============================================================ */
...
const Icons = {
  icons: {
    ...
    'plug': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a6 6 0 0 1-6 6v0a6 6 0 0 1-6-6V8z"/></svg>',
    ...
    'cookie': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5"/><path d="M8.5 8.5v.01"/><path d="M16 15.5v.01"/><path d="M12 12v.01"/><path d="M11 17v.01"/><path d="M7 14.5v.01"/></svg>',
  ...
  /**
   * Get an icon by name, optionally with custom size
  ...
  /**
   * Get icon wrapped in a span for inline use
   */
  span(name, size = 20, className = '') {
    return `<span class="icon ${className}" style="display:inline-flex;align-items:center;justify-content:center;width:${size}px;height:${size}px;">${this.get(name, size)}</span>`;
  }
};
